              ...
              {contactItems.map((item) => (
                <li key={item.label}>
                  {item.href ? (
                    ...
                    >
                      <span className="text-gray-600 group-hover:text-cyan-400 transition-colors">{item.icon}</span>
                      {item.label}
                    </a>
                  ) : (
