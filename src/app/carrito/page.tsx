            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-start justify-between gap-2">
                  <p className="font-semibold text-gray-800 text-sm leading-tight">{producto.nombre}</p>
                  <button
                    onClick={() => removeItem(producto.id)}
                    className="flex-shrink-0 p-1 text-gray-400 hover:text-red-500 transition-colors rounded-lg hover:bg-red-50"
                ...
                {producto.precio != null && (
                  <p className="text-xs text-blue-600 font-medium mt-0.5">{fmt(producto.precio)} c/u</p>
                )}
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  {producto.precio != null && (
                    <p className="text-sm font-bold text-gray-800">{fmt(producto.precio * cantidad)}</p>
                  )}
                </div>
              </div>
            </div>
