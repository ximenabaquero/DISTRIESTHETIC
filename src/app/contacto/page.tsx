  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-12 text-gray-800">Contáctanos</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-green-800 mb-2">¡Contacto Inmediato por WhatsApp!</h3>
                ...
                <p className="text-sm text-green-600 mt-3">📱 {telefono}</p>
              </div>
            </div>
      ...
      <footer className="bg-gray-800 text-white py-8 mt-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 text-sm">© 2025 DISTRIESTHETIC. Todos los derechos reservados.</p>
        </div>
      </footer>
    </div>
  );
